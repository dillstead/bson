...
bool test_toker(void)
{
    ...
    struct str test2 = str("-2147483648 2147483647"); 
    ...
    struct str test3 = str("-2147483649");
    struct str test4 = str("2147483648");
    struct toker_res outrange[] = {
        {{BRC_OUTRANGE, 1}, { 0 }}};
    struct str test5 = str("-x");
    struct str test6 = str("x");
    struct str test7 = str("\200");
    struct str test8 = str("\177");
    struct str test9 = str("\"hello\177");
    struct toker_res unexpected[] = {
        {{BRC_UNEXCHAR, 1}, { 0 }}};
    struct str test10 = str("\"hello world");
    struct toker_res unterm[] = {
        {{BRC_UNTERM, 1}, { 0 }}};
    struct str test11 = str("        ");
    struct str test12 = str("/* */   /*\n\n  */ ////    \n");
